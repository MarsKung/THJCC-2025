...
items_db = [
    ...
    Item(id=87, name="flag", description="U can't see me:)", price=9999999999, image="https://img.etimg.com/thumb/msid-87088964,width-300,height-225,imgsize-7052,resizemode-75/1.jpg", data="THJCC{Appl3_st0r3_M45t3r}")
]
...
async def get_items(request: Request, response: Response, id: int):
    ...
    if item:
        ...
        html_content = f"""
            <html>
                <body>
                    <h1>商品ID：{id}是我們引以為傲的商品</h1>
                    <iframe width=100% height=100% src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </body>
            </html>
            """
